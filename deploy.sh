...
echo "command - docker tag scraper:latest <aws-account-id>.dkr.ecr.us-west-2.amazonaws.com/technokrax-news-scraper:latest"
docker tag scraper:latest 654654573394.dkr.ecr.us-west-2.amazonaws.com/technokrax-news-scraper:latest
